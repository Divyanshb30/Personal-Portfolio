...
/**
 * HORIZON. The river pours into a light, and the light is a sun rising over the limb of a dark
 * world: the orb, grown vast. One statement holds over it: every road so far bends toward this light.
 */
